...
<div class="content">
    ...
    <table class="table table-bordered table-hover table-responsive content">
        ...
        <tbody>
            ...
            @foreach ($customers as $item_section_work)
            <tr class="hed">
                ...
                <td><img class="materialboxed" width="{{ $Settings[4] }}"
                    ...
                    <td><img class="materialboxed" width="{{ $Settings[4] }}"
                        src="{{Request::root()}}{!! $Settings[3] !!}{{ $item_section_work->Extension}}"></td>



  
                <td>
                    <a rel="tooltip" href="/admin/customers/{{ $item_section_work->id}}"
                    ...
                    <button type="button" idt="{{ $item_section_work->id}}" idm="{{ $item_section_work->Image}}"
                        route="{{Request::root()}}/admin/destroy/customers/{{ $item_section_work->id}}/{{ $item_section_work->Image}}"
