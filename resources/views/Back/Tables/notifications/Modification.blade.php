        ...
        <form action="{{ route('blog.update', ['id'=>$blog->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="input-field col s12">
                <textarea id="Explanation" class="materialize-textarea" name="Explanation">{{ $blog->Explanation}}</textarea>
            ...
            <div class="row">
              <div class="input-field col s12">
                <div class="form-group margin">
                  <textarea class="form-control" rows="5" id="textarea"  class="textarea" name="Topic" placeholder="مواعيد العمل">{{ $blog->Topic}}</textarea>
              </div>
              </div>
            </div>
            @if ($errors->has('Topic'))
...
<img class="responsive-img img-thumbnail" width="500"
src="{{Request::root()}}{{ $path }}{{ $blog->Image}}">
@endsection