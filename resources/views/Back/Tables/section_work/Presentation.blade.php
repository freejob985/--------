    ...
    <table class="table table-bordered table-hover table-responsive content">
        ...
        <tbody>
            ...
            <tr class="hed">
                ...
                <td>{!! set_lab_lang($item_section_work->Language) !!}</td>                <td>
                    <a rel="tooltip" href="/admin/section_work/{{ $item_section_work->id}}"
                    ...
                    <button type="button" idt="{{ $item_section_work->id}}" idm="{{ $item_section_work->Image}}"
                        route="{{Request::root()}}/admin/destroy/section_work/{{ $item_section_work->id}}/{{ $item_section_work->Image}}"
