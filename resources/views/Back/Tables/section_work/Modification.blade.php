...
<div class="container-fluid" style="height: 100%">
    <div class="container">
        ...
        <form action="{{  route('section_work.update',$section_work->id)  }}" method="POST" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
            <div class="row">
                <label>اللغة</label>
              ...
              <div class="row">
                <div class="input-field col s6">
                  <input id="Section" type="text" class="validate" name="Section" value="{{ $section_work->Section}}">
                  <label class="active" for="Section">القسم</label>
