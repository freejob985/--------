    ...
    <form action="{{route('slide.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Subject" type="text" class="validate" name="Subject" value="{{Request::old('Subject')}}">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Additional" type="text" class="validate" name="Additional" value="{{Request::old('Additional')}}">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Link" type="text" class="validate" name="Link" value="{{Request::old('Link')}}">
