    ...
    <form action="{{  route('services.update',$services->id)  }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group margin">
        <textarea class="form-control" rows="5" id="textarea" class="textarea" name="Topic"
          placeholder="مواعيد العمل">{{ $services->Topic}}</textarea>
      </div>
...
<img class="responsive-img img-thumbnail" width="150" src="{{Request::root()}}{{ $path }}{{ $services->Image}}">
@endsection