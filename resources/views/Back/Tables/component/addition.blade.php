    ...
    <form action="{{route('faq.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Question" type="text" class="validate" name="Question" value="{{Request::old('Question')}}">
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea id="Answer" class="materialize-textarea" name="Answer">{{Request::old('Answer')}}</textarea>
