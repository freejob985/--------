...
<div class="container-fluid" style="height: 100%">
  <div class="container">
    ...
    <form action="/admin/component/{{$component->id}}/{{$component->pag}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea id="Component25" class="materialize-textarea" name="Component25">{{ $component->Component25}}</textarea>
          <label for="Component25">Component25</label>
          @if ($errors->has('Component25'))
          <span class="helper-text" data-error="wrong" data-success="right">{{ $errors->first('Component25') }}</span>
          @endif
        </div>
      </div>
