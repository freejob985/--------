...
<div class="container-fluid" style="height: 100%">
  <div class="container">
    ...
    <form action="{{ route('MyEducation.up', ['id'=>$component->id]) }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
      ...
      <img class="responsive-img img-thumbnail" width="200"
      src="{{Request::root()}}/Front/assets/img/{{ $component->Component12}}">
