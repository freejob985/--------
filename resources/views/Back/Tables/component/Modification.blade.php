...
">
    ...
    <div class="container">
        @php
        $url_bace= route('component.index');
        @endphp
        ...
        <form action="{{ route('component.update', ['id'=>$component->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="input-field col s6">
                <input id="Question" type="text" class="validate" name="Question" value="{{ $component->Question}}">
            ...
            <div class="row">
              <div class="input-field col s12">
                <textarea id="Answer" class="materialize-textarea" name="Answer">{{ $component->Answer}}</textarea>
