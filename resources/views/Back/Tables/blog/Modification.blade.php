    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <select class="browser-default" name="Section">
          ...
          @foreach(\App\blog_sections::orderBy('id','desc')->get() as $blog_sections)
          <option value="{{ $blog_sections->Section}}">{{ $blog_sections->Section}}</option>
          @endforeach
        </select>
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea id="explanation" class="materialize-textarea"
            name="explanation">{{ $blog->explanation}}</textarea>
      ...
      <div class="form-group margin">
        <textarea class="form-control" rows="5" id="textarea" class="textarea" name="Topic"
          placeholder="مواعيد العمل">{{ $blog->Topic}}</textarea>
      </div>
      ...
      <div class="file-field input-field">
        ...
        src="{{Request::root()}}/front/assets/images/blog/{{ $blog->Image}}">
