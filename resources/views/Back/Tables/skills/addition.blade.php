    ...
    <form action="{{route('skills.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Skill" type="text" class="validate" name="Skill" value="{{Request::old('Skill')}}">
          <label class="active" for="Skill">Skill</label>
          @if ($errors->has('Skill'))
          <span class="helper-text" data-error="wrong" data-success="right">{{ $errors->first('Skill') }}</span>
          @endif
        </div>
      </div>
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Rating" type="number" class="validate" name="Rating" value="{{Request::old('Rating')}}">
          <label class="active" for="Rating">Rating</label>
          @if ($errors->has('Rating'))
          <span class="helper-text" data-error="wrong" data-success="right">{{ $errors->first('Rating') }}</span>
          @endif
        </div>
      </div>
