...
<div class="content">
    ...
    <table class="table table-bordered table-hover table-responsive content">
        ...
        <tbody>
            @if (count($works)>0)
            @foreach ($works as $item_section_work)
            <tr class="hed">
                ...
                <td>
                    <a rel="tooltip" href="/admin/works/{{ $item_section_work->id}}"
                    ...
                    <button type="button" idt="{{ $item_section_work->id}}" idm="{{ $item_section_work->Image}}"
                        route="{{Request::root()}}/admin/destroy/works/{{ $item_section_work->id}}/{{ $item_section_work->Image}}"
