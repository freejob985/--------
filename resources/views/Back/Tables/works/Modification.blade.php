...
<div class="container-fluid" style="height: 100%">
  <div class="container">
    ...
    <form action="{{  route('works.update',$works->id)  }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Title" type="text" class="validate" name="Title" value="{{ $works->Title}}">
      ...
      <div class="form-group margin">
        <textarea class="form-control" rows="5" id="textarea" class="textarea" name="explanation"
          placeholder="مواعيد العمل">{{ $works->explanation}}</textarea>
      </div>
    ...
    src="{{Request::root()}}{{ $path }}{{ $works->Image}}">
