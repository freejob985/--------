...
<div class="container-fluid" style="height: 100%">
  <div class="container">
    ...
    <form action="{{  route('blog_sections.update',$blog_sections->id)  }}" method="POST" enctype="multipart/form-data">
      {{ method_field('PATCH') }}
      @csrf
      ...
      <div class="row">
        <div class="input-field col s6">
          <input id="Section" type="text" class="validate" name="Section" value="{{ $blog_sections->Section}}">
