...
<div class="content">
    ...
    <table class="table table-bordered table-hover table-responsive content">
        ...
        <tbody>
            ...
            @foreach ($main_services as $item_customers)
            <tr class="hed">
                ...
                <td>
                    <a rel="tooltip" href="{{ route('main_services.edit', ['id'=>$item_customers->id]) }}"
                    ...
                    <button type="button" idt="{{ $item_customers->id}}" "
                        route="{{ route('main_services.destroy.dell', ['id'=>$item_customers->id,'img'=>$item_customers->id]) }}"
    ...
    <br>
    <a style="background: #011a25;" href="{{ route('main_services.create') }}" class="btn btn-primary btn-block btn-large">
