...
<div class="container-fluid" style="height: 100%">
    <div class="container">
        ...
        <form action="{{ route('main_services.update', ['id'=>$main_services->id]) }}" method="POST" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
            <div class="row">
              <label>اللغة</label>
            ...
            <div class="row">
              <div class="input-field col s6">
                <input id="Title" type="text" class="validate" name="Title" value="{{ $main_services->Title}}">
            ...
            <div class="row">
              <div class="input-field col s12">
                <textarea id="Explanation" class="materialize-textarea" name="Explanation">{{ $main_services->Explanation}}</textarea>
