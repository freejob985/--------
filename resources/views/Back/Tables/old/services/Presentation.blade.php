        ...
        <tbody>
            ...
            <tr class="hed">
                ...
                <td><img class="materialboxed" width="{{ $Settings[4] }}"
                        src="{{Request::root()}}{!! $Settings[3] !!}{{ $item_customers->img}}">
                </td>
                ...
                <td>
                    ...
                    <button type="button" idt="{{ $item_customers->id}}" idm="{{ $item_customers->img}}"
                        route="{{ route('services.destroy.dell', ['id'=>$item_customers->id,'img'=>$item_customers->img]) }}"
