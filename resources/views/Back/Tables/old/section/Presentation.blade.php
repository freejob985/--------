...
<div class="content">
            ...
            <tr class="hed">
                ...
                <td>
                    ...
                    <button type="button" idt="{{ $item_customers->id}}" "
                        route="{{ route('section.destroy.dell', ['id'=>$item_customers->id,'img'=>$item_customers->id]) }}"
    ...
    <br>
    <a style="background: #011a25;" href="{{ route('section.create') }}" class="btn btn-primary btn-block btn-large">
